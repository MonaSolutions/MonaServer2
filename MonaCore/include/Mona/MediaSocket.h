...
struct MediaSocket : virtual Static {
	...
	struct Writer : Media::Target, Media::Stream, virtual Object {
		...
		bool writeProperties(const Media::Properties& properties) { Media::Data::Type type(Media::Data::TYPE_UNKNOWN); const Packet& packet(properties(type)); return send<MediaSend<Media::Data>>(0, type, packet); }
